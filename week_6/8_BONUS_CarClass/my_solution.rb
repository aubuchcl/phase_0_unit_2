...
elsif answer == "run it like a boss"
    adventure_game.turn("right")
    
    "Dang bro I think you clipped someone in the crosswalk, better keep going"
else 
    "I'm not really sure what that means, this time its a freebie.  Keep going the pizza is getting cold"
end
